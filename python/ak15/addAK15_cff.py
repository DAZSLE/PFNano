...
def setupPFNanoAK15_data(process):
    ...
    add_BTV(process, runOnMC=False, addAK4=True, addAK8=True, addAK15=True, custom_tagger_name="InclParticleTransformerV1")
...
def setupPFNanoAK15_mc(process):
    ...
    add_BTV(process, runOnMC=True, addAK4=True, addAK8=True, addAK15=True, custom_tagger_name="InclParticleTransformerV1")
    process.NANOAODSIMoutput.fakeNameForCrab = cms.untracked.bool(True)  # needed for crab publication
    return process
